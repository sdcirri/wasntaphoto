...
@pytest.mark.asyncio
async def test_get_own_profile_by_id(user_api_setup: UserApiSetup) -> None:
    s = user_api_setup
...
@pytest.mark.asyncio
async def test_get_me_returns_own_profile(user_api_setup: UserApiSetup) -> None:
    s = user_api_setup
...
@pytest.mark.asyncio
async def test_get_other_users_profile_by_id(user_api_setup: UserApiSetup) -> None:
    s = user_api_setup
...
@pytest.mark.asyncio
async def test_get_nonexistent_user_returns_404(user_api_setup: UserApiSetup) -> None:
    s = user_api_setup
...
@pytest.mark.asyncio
async def test_change_username_updates_profile(user_api_setup: UserApiSetup) -> None:
    s = user_api_setup
...
@pytest.mark.asyncio
async def test_change_profile_picture_updates_propic(user_api_setup: UserApiSetup, checkerboard: bytes) -> None:
    s = user_api_setup
...
@pytest.mark.asyncio
async def test_new_user_follows_nobody(following_setup: FollowingSetup) -> None:
    s = following_setup
...
@pytest.mark.asyncio
async def test_following_user_adds_to_following_list(alice_following_bob: FollowingSetup) -> None:
...
@pytest.mark.asyncio
async def test_following_user_adds_follower_to_their_list(alice_following_bob: FollowingSetup) -> None:
    s = alice_following_bob
...
@pytest.mark.asyncio
async def test_unfollowing_user_removes_from_following_list(alice_following_bob: FollowingSetup) -> None:
    s = alice_following_bob
...
@pytest.mark.asyncio
async def test_blocking_user_adds_to_blocked_list(alice_blocked_annoying: FollowingSetup) -> None:
...
@pytest.mark.asyncio
async def test_blocking_followed_user_removes_them_from_following(alice_blocked_annoying: FollowingSetup) -> None:
    s = alice_blocked_annoying
    resp = await s.client.get('/users/me/following', headers=s.alice_headers)
...
@pytest.mark.asyncio
async def test_blocked_user_cannot_view_blocker_profile(alice_blocked_annoying: FollowingSetup) -> None:
    s = alice_blocked_annoying
...
@pytest.mark.asyncio
async def test_blocked_user_cannot_view_blocker_posts(alice_blocked_annoying: FollowingSetup) -> None:
    s = alice_blocked_annoying
...
@pytest.mark.asyncio
async def test_unblocking_user_removes_from_blocked_list(alice_blocked_annoying: FollowingSetup) -> None:
    s = alice_blocked_annoying
...
@pytest.mark.asyncio
async def test_cannot_follow_yourself(following_setup: FollowingSetup) -> None:
    s = following_setup
